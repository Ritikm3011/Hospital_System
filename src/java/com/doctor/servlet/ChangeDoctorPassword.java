...
public class ChangeDoctorPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (doctorDao.checkOldPasswod(doctorId, oldPassword)) {

                if (doctorDao.changePasswod(doctorId, newPassword)) {
                    session.setAttribute("successMsg", "Password Changed Successfully.");
                    response.sendRedirect("doctor/changePassword.jsp");
                } else {
                ...
                session.setAttribute("failMsg", "Invalid Old Password");
